...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        document.querySelector('#disconnection-overlay h2').textContent = t('noSession.title');
        document.getElementById('disconnection-detail').textContent = `${t('noSession.message')} (${err.message})`;
        return;
    }
